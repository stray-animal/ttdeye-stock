...
create table ttdeye_notify_record
(
...
(
    ...
    purchase_price       bigint        default 0                 not null comment '采购单价-分',
...
create table ttdeye_sku_shop_detail
(
...
create table ttdeye_stock_change_record
(
    ...
    sku_after_stock        int          default 0                 not null comment 'sku变更后库存',
    sku_batch_before_stock int          default 0                 not null comment 'sku批次原库存',
    sku_batch_after_stock  int          default 0                 not null comment 'sku批次现库存',
    occur_stock            int          default 0                 not null comment '出入库数量：发生量',
    direction              int          default 0                 not null comment '方向：1-入库，0-出库',
    batch_flag             int          default 0                 not null comment '是否批次出库：1-是，0-否',
    source_type            int          default 0                 not null comment '来源：1-人工操作，2-批量导入，3-订单',

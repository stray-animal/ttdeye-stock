...
public class KaoLaRSAUtil {
	...
	public static String sign(String content, String privateKey) {
		try {
			...
			return KaoLaBase64.encode(signed);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static boolean verify(String content, String sign,
		...
		try {
			...
			byte[] encodedKey = KaoLaBase64.decode(lakala_public_key);
			...
			boolean bverify = signature.verify(KaoLaBase64.decode(sign));
			return bverify;
	...
	protected static byte[] decryptByPublicKey(String content, PublicKey pk) {
		...
		try {
			...
			InputStream ins = new ByteArrayInputStream(KaoLaBase64.decode(content));
	...
	*/
	public static PrivateKey getPrivateKey(String privateKey)  {
		...
		keyBytes = KaoLaBase64.decode(privateKey);
	...
	*/
	public static PublicKey getPublicKey(String publicKey) {
		...
		try {
			...
			keyBytes = KaoLaBase64.decode(publicKey);
	...
	public static void main(String[] args) {
		String str = KaoLaBase64.encode("18505933993".getBytes());
		...
		System.out.println("原文-->" + new String(KaoLaBase64.decode(str)));
	}

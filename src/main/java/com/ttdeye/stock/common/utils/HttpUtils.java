...
public class HttpUtils {
    ...
    private static final String TAG_TYPE_PUT_JSON = "JSON格式的PUT请求";
    private static final String TAG_TYPE_DELETE = "简单的DELETE请求";
...
//                header(WebConfig.ZHENG_UPMS_USER_INFO,sessionId).
     ...
     * @return
     */
    public static String putJson(String url, String requestParams) {
        return putJson(url, requestParams, null);
    }
     ...
     * @return
     */
    public static String putJson(String url, String requestParams, Map<String, Object> headerParams) {
        validRequestParams(url, requestParams);

        Request.Builder requestBuilder = new Request.Builder()
                .tag(TAG_TYPE_PUT_JSON).url(url);
    ...
    public static String postJson(String url, Map<String, Object> requestParams, Map<String, Object> headerParams) {
        ...
        //请求参数form
        RequestBody body = RequestBody.create(JSON, JacksonUtil.toJsonString(requestParams));
    ...
    private static byte[] handleStreamResponse(Request request) {
        ...
        try {
            ...
            if (contentType.contains(JSON.subtype())) {
                Map result = JacksonUtil.jsonStrToStringMap(response.body().string());

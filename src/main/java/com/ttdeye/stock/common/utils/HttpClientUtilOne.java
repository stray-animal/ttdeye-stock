 ...
 * date ：20180709
 */
public class HttpClientUtilOne {
    ...
    public static Optional<String> post(String url, TreeMap<String, String> treeMap) {
        ...
        List<BasicNameValuePair> formparams = HttpClientUtilOne.getNamedValuePairFromTreeMap( treeMap );
        int times = 0;
    ...
    public static Optional<String> post(String url) {
        return HttpClientUtilOne.post(url, null);
    }
    ...
    public static Optional<String> get(String url, TreeMap<String, String> treeMap) {
        String innerUrl = url;
        String paramStr = HttpClientUtilOne.getParamStringFromMap(treeMap);
    ...
    public static Optional<String> get(String url) {
        return  HttpClientUtilOne.get(url, null);
    }
    ...
    public static Optional<String> delete(String url) {
        return  HttpClientUtilOne.delete(url, null);
    }
